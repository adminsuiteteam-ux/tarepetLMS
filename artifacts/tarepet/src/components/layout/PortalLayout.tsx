...
const ROLE_NAV: Record<string, NavSection[]> = {
  ...
  TEACHER: [
    { id: 'overview',    label: 'Dashboard Overview',       icon: LayoutDashboard },
    { id: 'classes',     label: 'My Classes & Courses',     icon: BookOpen },
    { id: 'content',     label: 'Lesson Builder & Content', icon: PenLine },
    { id: 'grading',     label: 'Grading & Rubrics',        icon: FileText, badge: 3 },
    { id: 'attendance',  label: 'Attendance & Marking',     icon: UserCheck },
    { id: 'students',    label: 'Student Roster & Support', icon: Users },
    { id: 'montessori',  label: 'Montessori & Observations',icon: Star },
    { id: 'messages',    label: 'Messages & Broadcasts',    icon: MessageSquare, badge: 2 },
  ...
  STUDENT: [
    ...
    { id: 'assignments', label: 'Assignments & Quizzes',icon: ClipboardList, badge: 2 },
    { id: 'grades',      label: 'Grades & Analytics',   icon: BarChart2 },
    { id: 'attendance',  label: 'Attendance',           icon: UserCheck },
    { id: 'houses',      label: 'House System',         icon: Trophy },
    { id: 'portfolio',   label: 'My Portfolio',         icon: Briefcase },
    { id: 'journal',     label: 'Work Journal',         icon: PenLine },
    { id: 'messages',    label: 'Messages',             icon: MessageSquare, badge: 3 },
    { id: 'timetable',   label: 'Calendar & Timetable', icon: Calendar },
