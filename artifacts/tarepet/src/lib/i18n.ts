...
const defaultTranslations = new Map<string, string>([
  ...
  ['teacher.present_status', 'PRESENT'],
  ['teacher.present_and_cleared', 'Present & Cleared'],
  ['teacher.mark_present_btn', 'Mark Present'],
  ['teacher.mark_all_present', 'Mark All Present'],
  ['teacher.clear_all', 'Clear All'],
  ['teacher.close_btn', 'Close'],
  ['teacher.cancel_btn', 'Cancel'],
  ['teacher.student_label', 'Student'],
  ['teacher.exam_label', 'Exam:'],
  ['teacher.submitted_label', 'Submitted: '],
  ['teacher.verified_score_label', 'Verified Score'],
  ['teacher.student_info_header', 'Student Information'],
  ['teacher.hall_attendance_policy', 'Hall Attendance Clearance Policy'],
  ['teacher.only_students_marked', 'Only students marked '],
  ['teacher.below_granted_access', 'below will be granted access to start this examination in their student portal.'],
  ['teacher.class_roster_prefix', 'Class Roster ('],
  ['teacher.class_roster_suffix', ' Students)'],
  ['teacher.broadsheet_auto_save_notice', 'All changes are saved automatically in real-time. Click below to publish to official terminal report cards.'],
  ['teacher.broadsheet_click_row_desc', 'Click any student row below to open their individual fillable broadsheet (1st CA, 2nd CA, Assignment, CBT Exam & Paper Exam).'],
  ['teacher.save_student_record_btn', 'Save Student Record'],
  ['teacher.parent_info_header', 'Parent / Guardian Information'],
  ['teacher.student_full_name_label', 'Student Full Name *'],
  ['teacher.gender_label', 'Gender'],
  ['teacher.gender_male', 'Male'],
  ['teacher.gender_female', 'Female'],
  ['teacher.dob_label', 'Date of Birth'],
  ['teacher.student_email_label', 'Student Email (Optional)'],
  ['teacher.res_address_label', 'Residential Address'],
  ['teacher.parent_name_label', 'Parent / Guardian Name'],
  ['teacher.parent_phone_label', 'Parent Contact Phone'],
  ['teacher.config_ind_exam', 'Configure Individual Student Exam'],
  ['teacher.select_target_pupil', 'Select Target Pupil'],
  ['teacher.student_certified_present', 'Student Certified Present in Hall'],
  ['teacher.attendance_warning_absent', 'Attendance Warning: Student Marked Absent'],
  ['teacher.sync_report_cards', 'Sync All Scores to Report Cards'],
