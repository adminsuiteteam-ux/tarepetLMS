...
import { ArrowRight, BookOpen, Heart, Users, CheckCircle2, Quote, Sparkles, GraduationCap, Globe, ShieldCheck } from "lucide-react";
    ...
    <PageTransition>
      ...
      <section className="relative min-h-[90vh] flex items-center pt-10 pb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-secondary/95 via-secondary/85 to-secondary/50 mix-blend-multiply" />
          <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px]" />
        </div>

        {/* Floating Decorative Glass Spheres */}
        <div className="absolute top-20 right-10 w-96 h-96 bg-primary/20 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-10 left-10 w-96 h-96 bg-secondary/30 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl">
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full glass-button text-white text-xs md:text-sm font-semibold mb-6 shadow-lg"
            >
            ...
            >
              Nurturing <span className="text-primary italic font-light">Excellence</span> <br/>in Every Child.
            </motion.h1>
            ...
            >
              <Link 
                href="/sign-in" 
                className="inline-flex items-center justify-center rounded-full text-base font-semibold transition-all duration-300 bg-gradient-to-r from-primary to-primary/90 text-white hover:shadow-xl hover:shadow-primary/30 h-14 px-8 py-3 group active:scale-95"
              >
                Portal Login
              ...
              <Link 
                href="/about" 
                className="inline-flex items-center justify-center rounded-full text-base font-semibold transition-all duration-300 glass-button text-white hover:bg-white/20 h-14 px-8 py-3 active:scale-95"
              >
                Discover Our Method
              </Link>
            </motion.div>
      ...
      <section className="py-24 bg-background relative">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div 
              whileHover={{ y: -6 }}
              className="glass-card rounded-2xl p-8 border border-white/80 shadow-md group relative overflow-hidden"
            >
              <div className="w-14 h-14 bg-secondary/15 rounded-2xl flex items-center justify-center mb-6 text-secondary group-hover:bg-secondary group-hover:text-white transition-all duration-300 shadow-sm">
                <Heart className="w-7 h-7" />
              </div>
              <h4 className="text-2xl font-serif font-bold mb-3 text-foreground">Nursery</h4>
              ...
              <Link href="/programs" className="inline-flex items-center text-primary font-semibold hover:underline group-hover:translate-x-1 transition-transform">
            ...
            <motion.div 
              ...
              className="glass-card rounded-2xl p-8 border border-white/80 shadow-md group relative overflow-hidden"
            >
              <div className="w-14 h-14 bg-primary/15 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300 shadow-sm">
                <BookOpen className="w-7 h-7" />
              </div>
              <h4 className="text-2xl font-serif font-bold mb-3 text-foreground">Primary</h4>
            ...
            >
              ...
              <h4 className="text-2xl font-serif font-bold mb-3 text-foreground">Secondary</h4>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="mt-10">
                <Link href="/about" className="inline-flex items-center text-white font-semibold border-b-2 border-primary pb-1 hover:text-primary transition-colors">
                  Learn more about our philosophy <ArrowRight className="ml-2 w-4 h-4" />
                </Link>
              </div>
            </div>
            
            <div className="relative">
              <div className="aspect-[4/5] rounded-3xl overflow-hidden border-8 border-white/10 shadow-2xl relative z-10">
                <img
                  src={philosophyImg}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                key={i} 
                whileHover={{ y: -4 }}
                className="glass-card p-8 rounded-2xl shadow-sm relative border border-white/80"
              >
      ...
      <section className="py-24 bg-background text-center relative overflow-hidden border-t border-border">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto glass-card p-12 rounded-3xl border border-white/80 shadow-2xl relative">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link 
                href="/sign-in" 
                className="inline-flex items-center justify-center rounded-full text-base font-semibold bg-gradient-to-r from-primary to-primary/90 text-white hover:shadow-xl hover:shadow-primary/25 h-14 px-8 py-3 active:scale-95 transition-transform"
              >
                Portal Login
              </Link>
              <Link 
                href="/contact" 
                className="inline-flex items-center justify-center rounded-full text-base font-semibold glass-button text-foreground hover:bg-white h-14 px-8 py-3 active:scale-95 transition-transform"
              >
                Schedule a Tour
              </Link>
            </div>
