...
class CBTExam(models.Model):
    ...
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, null=True, blank=True, related_name='cbt_exams')
    course_name = models.CharField(max_length=150, blank=True, default='General Assessment', help_text=_('Course or Subject Name'))
    course_code = models.CharField(max_length=50, blank=True, default='GEN-101', help_text=_('Course or Subject Code'))
    teacher = models.ForeignKey(TeacherProfile, on_delete=models.SET_NULL, null=True, blank=True, related_name='created_cbt_exams')
    teacher_name = models.CharField(max_length=150, blank=True, default='Assigned Educator', help_text=_('Teacher Full Name'))
